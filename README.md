# Bank – Intelligent Onboarding & Verification System
Cloud + Bedrock Integration (AWS Demonstration Project) . Made for a Nordic Bank. 
...

{
  ...
  "email": "juanpablo.zunigahidalgo@bank.com",
  "status": "REGISTERED",
...
Serves as an internal view for Bank personnel.
